	...
	<body> 
		...
		<div id="page-top-outer">    
			...
			<div id="page-top">
				...
				<!-- start logo -->
				<div id="logo">
					<a href=""><img src="<?php echo base_url();?>images/shared/logo_admin.png" width="320" height="73" alt="" /></a>
				</div>
				<!-- end logo -->
		...
		<div class="nav-outer-repeat"> 
            ...
            <? echo $this->load->view('admin/menu_atas'); ?>
				<!--  start nav -->
			</div>
			<div class="clear"></div>
			<!--  start nav-outer -->
		...
		<div id="footer">
			<!--  start footer-left -->
			<div id="footer-left"><strong>Umroh Online Management System</strong> | Kamilah Wisata - Membangun Karakter Jamaah Menuju Kehidupan yang Lebih Baik.</div>
			<!--  end footer-left -->
			<div class="clear">&nbsp;</div>
		</div>
		<!-- end footer -->
