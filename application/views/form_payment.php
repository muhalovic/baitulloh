...
<table width="100%" class="front_price" align="center">
	...
	?>	
	<tr height="30">
		<td align="left"><h4><span class="price_list_packet">Jasa Pengurusan Buku Meningitis</span></h4></td>
	...
	<tr height="30">
		<td align="left"><h4><span class="price_list_packet">DISKON <em>(pendaftaran via online)</em></span></h4></td>
		<td align="center"><h4></h4></td>
		<td align="center"><h4>$ 70.00</h4></td>
		<td align="center"><h4>1 x</h4></td>
		<td align="center"><h4 class="price_list_packet">- $ 70</h4></td>
    </tr>		
...
<table width="100%" class="front_payment" align="center">
	<tr height="30">
		...
		<td width="125" class="bg_kolom"><h3>BIAYA</h3></td>
		<td width="125" class="bg_kolom"><h3>NOMINAL<br />DIBAYARKAN</h3></td>
		<td width="90" class="bg_kolom"><h3>STATUS YANG DIBAYARKAN</h3></td>
		<td width="90" class="bg_kolom"><h3>TOTAL YANG DIBAYARKAN</h3></td>
		<td width="90" class="bg_kolom"><h3>STATUS LUNAS</h3></td>
		<td width="90" class="bg_kolom"><h3>KEKURANGAN</h3></td>
		<td width="90" class="bg_kolom"><h3>JATUH TEMPO</h3></td>
    </tr>	
	<tr height="30">
	...
	<tr height="30">
		<td class="bg_kolom_right front_payment_top" rowspan="<? if(isset($rowspan_pelunasan)) { echo $rowspan_pelunasan; } ?>">
        	<h4>Sisa Pelunasan </h4>
        </td>
		<td align="center" rowspan="<? if(isset($rowspan_pelunasan)) { echo $rowspan_pelunasan; } ?>">
        	$ <? if(isset($biaya_pelunasan)) { echo $biaya_pelunasan; } ?>
        </td>
		<? if(isset($looping_pelunasan)) { echo $looping_pelunasan; } ?> 
		<td align="center" rowspan="<? if(isset($rowspan_pelunasan)) { echo $rowspan_pelunasan; } ?>">
			<? if(isset($tgl_pelunasan)) { echo $tgl_pelunasan; } ?>
        </td>
    </tr>
    <? if(isset($looping_pelunasan2)) { echo $looping_pelunasan2; } ?> <br />
   
	<tr height="30">
		<td class="bg_kolom_right front_payment_top" rowspan="<? if(isset($rowspan_manasik)) { echo $rowspan_manasik; } ?>">
        	<h4>Airport Tax & Manasik</h4>
        </td>
		<td align="center" rowspan="<? if(isset($rowspan_manasik)) { echo $rowspan_manasik; } ?>">
        	Rp. 700.000
        </td>
		<? if(isset($looping_manasik)) { echo $looping_manasik; } ?> 
		<td align="center" rowspan="<? if(isset($rowspan_manasik)) { echo $rowspan_manasik; } ?>">
			<? if(isset($tgl_pelunasan)) { echo $tgl_pelunasan; } ?>
        </td>
    </tr>
    <? if(isset($looping_manasik2)) { echo $looping_manasik2; } ?> <br />
	...
	<tr height="30" valign="bottom">
		...
		<td align="center"><h4><? if(isset($total_yg_sudah_dibayarkan)) { echo '$ '.$total_yg_sudah_dibayarkan.' + '; } ?><? if(isset($total_yg_sudah_dibayarkan_rupiah)) { echo 'Rp. '.$total_yg_sudah_dibayarkan_rupiah; } ?></h4></td>
		<td align="center"></td>
		<td align="center"></td>
		<td align="center"></td>
		<td align="center"></td>
